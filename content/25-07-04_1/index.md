...
* **Computer Vision**: YuNet (정면얼굴 검출), Google Vision API (텍스트 추출), OpenCV, KMeans (색상 분석), OpenAI API (SAM, YOLOv8, mediapipe 등 실험하면서 더 써봄,,)
* **NLP**: OpenAI API(오감자극표현 여부, 관심 유도 표현 정도), TfidfVectorizer (감성·일상 테마 분류)
